...
thresholds = [5000] #[1, 10, 100, 300, 500, 700, 800, 900, 1000, 2000, 3000, 5000]
#[100, 300, 500, 700, 800, 900, 1000, 2000, 3000, 5000, 7000, 10000, 20000]

for i in thresholds:

  remove_entity = []
  for n in range(i):
      remove_entity.append(table_cnt_all.tail(i).iat[n,0]) #tail for bottom

  # Form a new dataset

  path = '/home/kang/.data/pykeen/datasets/fb15k/FB15k/ds1/freebase_mtr100_mte100-test.txt'
  ...
  training = '/home/kang/.data/pykeen/datasets/fb15k/FB15k/ds1/freebase_mtr100_mte100-train.txt'
  testing = '/home/kang/.data/pykeen/datasets/fb15k/FB15k/ds1/freebase_mtr100_mte100-test.txt'
  validation = '/home/kang/.data/pykeen/datasets/fb15k/FB15k/ds1/freebase_mtr100_mte100-valid.txt' 
  ...
  hpo_result.save_to_directory('fb15k_ratate_hpo_ds-3_num'+str(i))